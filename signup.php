...
<table align="center">
<tr> <td align="center">
	<h1 style="color:red">  Enter username and password. </h1>
<form method="POST">
...
<?php 
	...
	$query = 'SELECT COUNT(*) AS cred FROM users WHERE Username="' . $_POST['username'] . '"';
	$cursor = $cnx->query($query);
	while ($row = $cursor->fetch_assoc()) {
		$valid = $row['cred'];
	}
	if ($valid == 1) {
		echo '<h4 style="color:red"> Username already taken. Use a different username.</h4> <br>';
	}
	else {
